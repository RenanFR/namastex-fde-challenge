...
Resposta ao desafio FDE da Namastex. O enunciado original está em [`DESAFIO.md`](DESAFIO.md).
...
As conversas com IA durante o desafio estão em `ai-logs/`, conforme pedido no enunciado.
